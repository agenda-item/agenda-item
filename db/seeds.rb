...
@agm2 = Meeting.create!(meeting_date: DateTime.strptime("08/08/2014 15:47", "%m/%d/%Y %H:%M"), title: "Annual AGM - Monkey", status: "draft")
@agm3 = Meeting.create!(meeting_date: DateTime.strptime("09/09/2014 15:47", "%m/%d/%Y %H:%M"), title: "Annual AGM - Island", status: "draft")
