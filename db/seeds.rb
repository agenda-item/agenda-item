...
@agm2 = Meeting.create!(meeting_date: DateTime.strptime("03/06/2014 15:47", "%m/%d/%Y %H:%M"), title: "Annual AGM - Do ahead, delete me", status: "draft")

@agm3 = Meeting.create!(meeting_date: DateTime.strptime("09/16/2014 15:47", "%m/%d/%Y %H:%M"), title: "Annual AGM - If you dare!!", status: "draft")
